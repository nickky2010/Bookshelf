...
{
    public class UnitOfWorkExceptionMessageOnEnglish : IUnitOfWorkExceptionMessageLocalization
    {
        ...
        public IAuthorsExceptionMessageLocalization AuthorsException
        {
            get
            {
                ...
                {
                    _authorsException = new Lazy<IAuthorsExceptionMessageLocalization>(new AuthorsExceptionMessageOnEnglish());
                }
        ...
        public IBooksExceptionMessageLocalization BooksException
        {
            get
            {
                ...
                {
                    _booksException = new Lazy<IBooksExceptionMessageLocalization>(new BooksExceptionMessageOnEnglish());
                }
        ...
        public IGenresExceptionMessageLocalization GenresException
        {
            get
            {
                ...
                {
                    _genresException = new Lazy<IGenresExceptionMessageLocalization>(new GenresExceptionMessageOnEnglish());
                }
        ...
        public ITagsExceptionMessageLocalization TagsException
        {
            get
            {
                ...
                {
                    _tagsException = new Lazy<ITagsExceptionMessageLocalization>(new TagsExceptionMessageOnEnglish());
                }
        ...
        public IUsersExceptionMessageLocalization UsersException
        {
            get
            {
                ...
                {
                    _usersException = new Lazy<IUsersExceptionMessageLocalization>(new UsersExceptionMessageOnEnglish());
                }
        ...
        public IRolesExceptionMessageLocalization RolesException
        {
            get
            {
                ...
                {
                    _rolesException = new Lazy<IRolesExceptionMessageLocalization>(new RolesExceptionMessageOnEnglish());
                }
        ...
        public IBookGroupsExceptionMessageLocalization BookGroupsException
        {
            get
            {
                ...
                {
                    _bookGroupsException = new Lazy<IBookGroupsExceptionMessageLocalization>(new BookGroupsExceptionMessageOnEnglish());
                }
        ...
        public ILanguagesExceptionMessageLocalization LanguagesException
        {
            get
            {
                ...
                {
                    _languagesException = new Lazy<ILanguagesExceptionMessageLocalization>(new LanguagesExceptionMessageOnEnglish());
                }
        ...
        public IPublishingHousesExceptionMessageLocalization PublishingHousesException
        {
            get
            {
                ...
                {
                    _publishingHousesException = new Lazy<IPublishingHousesExceptionMessageLocalization>(new PublishingHousesExceptionMessageOnEnglish());
                }
        ...
        public ISeriesExceptionMessageLocalization SeriesException
        {
            get
            {
                ...
                {
                    _seriesException = new Lazy<ISeriesExceptionMessageLocalization>(new SeriesExceptionMessageOnEnglish());
                }
        ...
        public IDataExceptionMessageLocalization DataException
        {
            get
            {
                ...
                {
                    _dataException = new Lazy<IDataExceptionMessageLocalization>(new DataExceptionMessageOnEnglish());
                }
        ...
        public IReportExceptionMessageLocalization ReportException
        {
            get
            {
                ...
                {
                    _reportException = new Lazy<IReportExceptionMessageLocalization>(new ReportExceptionMessageOnEnglish());
                }
        ...
        public IDbUpdateConcurrencyExceptionMessageLocalization DbUpdateConcurrencyException
        {
            get
            {
                ...
                {
                    _dbUpdateConcurrencyException = new Lazy<IDbUpdateConcurrencyExceptionMessageLocalization>(new DbUpdateConcurrencyExceptionMessageOnEnglish());
                }
