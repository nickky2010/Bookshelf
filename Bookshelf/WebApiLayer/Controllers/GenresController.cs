...
namespace WebApiLayer.Controllers
{
    ...
    {
        // GET: api/Genre
        IDataBaseService<GenreDTO> _dataBaseService;
        public GenresController(IDataBaseService<GenreDTO> dataBaseService)
        {
        ...
        // POST api/<controller>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]GenreDTO value)
        {
            if (value == null)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody]GenreDTO value)
        {
            if (value == null)
                throw new BadRequestException(_dataBaseService.UnitOfWorkExceptionMessage.DataException.NoData);
            if (id < 1)
