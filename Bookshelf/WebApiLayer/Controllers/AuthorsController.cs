...
namespace WebApiLayer.Controllers
{
    ...
    {
        // GET: api/Author
        IDataBaseService<AuthorDTO> _dataBaseService;
        public AuthorsController(IDataBaseService<AuthorDTO> dataBaseService)
        {
        ...
        // POST api/<controller>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]AuthorDTO value)
        {
            if (value == null)
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody]AuthorDTO value)
        {
            if (value == null)
                throw new BadRequestException(_dataBaseService.UnitOfWorkExceptionMessage.DataException.NoData);
            if (id < 1)
